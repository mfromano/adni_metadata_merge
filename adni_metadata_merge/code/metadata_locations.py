...
tau2 = {'loc': TAUMETA2_LOC, 'fields': tau2_fields, 'isexam': 1,
        'isimage': 1, 'DONECOL': 'DONE', 'DATE': 'SCANDATE', 'DATEFORMAT':
            '%Y-%m-%d'}
...
pib_fields = ['RID', 'VISCODE', 'EXAMDATE', 'PBCONDCT']
pib = {'loc': PIBMETA_LOC, 'fields': pib_fields, 'isexam': 1,
       'isimage': 1, 'DONECOL': 'PBCONDCT', 'DATE': 'EXAMDATE', 'DATEFORMAT':
           '%m/%d/%Y'}
...
mri1 = {'loc': MRI1META_LOC, 'fields': mri1_fields, 'isexam': 1,
        'isimage': 1, 'DONECOL': 'MMCONDCT', 'DATE': 'EXAMDATE', 'DATEFORMAT':
            '%Y-%m-%d'}
...
amyloid = {'loc': AV45META_LOC, 'fields': av45_fields, 'isexam': 1,
           'isimage': 1, 'DONECOL': 'PMCONDCT', 'DATE': 'EXAMDATE', 'DATEFORMAT':
               '%Y-%m-%d'}
...
coding for "ARM"
1=NL - 1.5T only	2=MCI - 1.5T only	3=AD - 1.5T only
4=NL - PET+1.5T     5=MCI - PET+1.5T	6=AD - PET+1.5T	7=NL - 3T+1.5T
8=MCI - 3T+1.5T	9=AD - 3T+1.5T
"""
...
ADNI2GO_TRANS = {1: 'NL', 2: 'MCI', 3: 'AD', 4: 'MCI', 5: 'AD', 6: 'AD',
                 7: 'NL', 8: 'MCI', 9: 'NL'}
ARM_ADNI2_TRANS = {1: 'NL', 2: 'MCI', 3: 'AD', 4: 'NL', 5: 'MCI', 6:
                   'AD', 7: 'NL', 8: 'LMCI', 9: 'AD', 10:'EMCI', 11:'SMC'}
ARM_ADNIGO_TRANS = {1: 'NL', 2: 'MCI', 3: 'AD', 4: 'NL', 5: 'MCI', 6:
                    'AD', 7: 'NL', 8: 'MCI', 9: 'AD', 10: 'EMCI'}
ARM_ADNI1_TRANS = {1: 'NL', 2: 'MCI', 3: 'AD', 4: 'NL', 5: 'MCI', 6: 'AD',
                   7: 'NL', 8: 'MCI', 9: 'AD'}

FILE_LIST = {'tau2': tau2, 'tau3': tau3, 'mri1': mri1, 'mri3': mri3,
             'pib': pib, 'mmse': mmse, 'npiq': npiq, 'npi': npi, 'nb': nb,
             'moca': moca, 'cdr': cdr, 'reg': reg, 'dxsum': dxsum,
             'arm': arm, 'amyloid': amyloid, 'amyloid2': amyloid2}


DX_TRANS = {'ADNI1': ADNI1_TRANS, 'ADNI2': ADNI2GO_TRANS,
            'ADNIGO': ADNI2GO_TRANS, 'ADNI3': ADNI3_TRANS,
            'ARM': {'ADNI1': ARM_ADNI1_TRANS, 'ADNI2': ARM_ADNI2_TRANS,
                    'ADNIGO': ARM_ADNIGO_TRANS}}

IMAGE_KEYS = ['DONECOL','DATE','DATEFORMAT']